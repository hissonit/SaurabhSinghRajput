<%@ Page Title="" Language="C#" MasterPageFile="~/user/mainforuser.master" AutoEventWireup="true" CodeFile="changePassword.aspx.cs" Inherits="changePassword" %>
            ...
            <div class="row">   
                <div class="center ">
                    <div class="icon-block">
                        <asp:Button ID="chngepasswordbtn" class="waves-effect waves-light btn" style="background-color:#8D0D64"  runat="server"   text="Change Password"  formmethod="post" OnClick="chngepass_btnclick"  />
