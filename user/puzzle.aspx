<%@ Page Title="" Language="C#" MasterPageFile="~/user/mainforuser.master" AutoEventWireup="true" CodeFile="puzzle.aspx.cs" Inherits="user_puzzle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div >
        <p style="margin-top:-15px;  text-align: center; font-family: 'Bookman Old Style'; font-size:50px; font-weight: bold">Puzzle Competition</p>
    </div>
    <!--Questions-->
     <ul class="collapsible" data-collapsible="accordion" style="margin-top:7%">
        <li>
            ...
            <div class="collapsible-body">
                <p style="font-family: Calibri Light,'Times New Roman',sans-serif,Verdana; font-size: large">Solve the Puzzle And upload it in .pdf format.</p>
                <div style="margin-left: 15%" class="row">

                    
                    <div class="row" style="margin-left: 110px;">
                       <a href="../Questions/PUZZLE1.pdf"  style="font-size:medium" class="waves-effect waves-light btn" download="PUZZLE1.pdf"> Download</a>
                    </div>
        ...
        <li>
            ...
            <div class="collapsible-body">
                ...
                <div style="margin-left: 15%" class="row">
                    ...
                    <div class="row" style="margin-left: 110px;">
                       <a href="../Questions/PUZZLE2.pdf" style="font-size:medium" class="waves-effect waves-light btn" download="PUZZLE2.pdf"> Download</a>
                    </div>
                    </div>
                    <table style="width: 100%;">
                        <tr>
        ...
        <li>
            ...
            <div class="collapsible-body">
                ...
                <div style="margin-left: 15%" class="row">
                    ...
                    <div class="row" style="margin-left: 110px;">
                       <a href="../Questions/PUZZLE3.pdf" class="waves-effect waves-light btn" style="font-size:medium" download="PUZZLE3.pdf"> Download</a>
                    </div>
                </div>
                 <table style="width: 100%;">
                        <tr>
