<%@ Page Title="" Language="C#" MasterPageFile="~/user/mainforuser.master" AutoEventWireup="true" CodeFile="profile.aspx.cs" Inherits="profile" %>
...
<div class="col">
    ...
    <div> <asp:Button runat="server" id="chnge"  style="color: blue; font-weight:normal; font-size: medium" Text="Change Picture" Width="100%" OnClick="chnge_Click" OnClientClick="ValidateFile()" CausesValidation="False"></asp:Button>
     </div>
        </div>
    ...
    <table style="width: 100%; height: 253px;">
        <tr>
            ...
            <td>
                <p style="display:inline;">Name:  </p><asp:Label ID="Label1" CssClass="userinfo" runat="server" ForeColor="#0033CC"></asp:Label>
            </td>
            <td>
                <p style="display:inline;">Email:  </p><asp:Label ID="Label2" runat="server"  CssClass="userinfo" ForeColor="#0033CC"></asp:Label>

            </td>
        </tr>
        <tr>
            <td class="auto-style2">
               <p style="display:inline;">Mobile:  </p> <asp:Label ID="Label3" runat="server" CssClass="userinfo" ForeColor="#0033CC"></asp:Label></td>
            <td class="auto-style2">
                <p style="display:inline;">Course:  </p><asp:Label ID="Label4" runat="server" CssClass="userinfo" ForeColor="#0033CC"></asp:Label></td>

        </tr>
        <tr>
            <td colspan="2">
                <p style="display:inline;">User id:  </p><asp:Label ID="Label5" runat="server" CssClass="userinfo" ForeColor="#0033CC"></asp:Label>
                        ...
                        <div class="row">
                            <div class="center ">
                                <div class="icon-block">
                                    <asp:Button ID="update" class="waves-effect waves-light btn" Style="background-color: #8D0D64" runat="server" Text="Update" formmethod="post"  OnClick="update_btn" />
